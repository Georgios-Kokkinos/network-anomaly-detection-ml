...
End-to-end training pipeline entry point for Version 2 (DL baseline).
...
from src.data.data_loader import load_cicids_data
...
from src.utils.helpers import ensure_dir, project_root, save_dataframe, save_json, save_text, set_seeds
...
def main() -> None:
    ...
    # Load and merge CICIDS CSV files.
    df = load_cicids_data(
        data_dir,
